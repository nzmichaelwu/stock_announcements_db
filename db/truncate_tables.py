...
if postgresql_engine.execute("Select count(*) from afr_street_talk").fetchall()[0][0] == 0:
...
if postgresql_engine.execute("Select count(*) from aus_tradingday").fetchall()[0][0] == 0:
